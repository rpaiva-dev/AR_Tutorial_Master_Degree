...
public class ModalEditPreviewTutorialController : MonoBehaviour
{
    ...
    private Action editTutorialAction;
    ...
    void Awake()
    {
        ...
        btn_Yes.onClick.AddListener(() => editTutorialAction.Invoke());
    }

    public void ModalEditTaskConstructor(Action editTutorialAction)
    {
        this.editTutorialAction = editTutorialAction;
    }
