...
public class ModalDuplicateTutorial : MonoBehaviour
{
    ...
    private Action duplicateTutorialAction;
    ...
    void Awake()
    {
        ...
        btn_Yes.onClick.AddListener(() => { duplicateTutorialAction.Invoke(); Destroy(this.gameObject); });
    }

    public void ModalDuplicateTutorialConstructor(Action duplicateTutorialAction)
    {
        this.duplicateTutorialAction = duplicateTutorialAction;
    }
