...
public class ModalViewTutorialController : MonoBehaviour
{
    ...
    private Action viewTutorialAction;
    ...
    void Awake()
    {
        ...
        btn_Yes.onClick.AddListener(() => viewTutorialAction.Invoke());
    }

    public void ModalViewTutorialConstructor(Action viewTutorialAction)
    {
        this.viewTutorialAction = viewTutorialAction;
    }
