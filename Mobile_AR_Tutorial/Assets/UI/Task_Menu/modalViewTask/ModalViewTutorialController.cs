...
public class ModalViewTaskController : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        btn_Yes.onClick.AddListener(() => viewTaskAction.Invoke());
    }

    public void ModalViewTaskConstructor(Action viewTaskAction)
    {
        this.viewTaskAction = viewTaskAction;
    }
}
